			...
			<table class="list">
				...
				<c:forEach items="${offers}" var="offer">
					<tr>
						...
						<td><a href="${pageContext.request.contextPath}/offer/update/${offer.id}.html" onclick="return confirm('Do you want to edit this offer?')" >Edit</a>
						<td><a href="${pageContext.request.contextPath}/offer/delete/${offer.id}.html" onclick="return confirm('Do you want to remove this offer?')" >Remove</a>
					</tr>
				</c:forEach>
			</table>
		</div>
