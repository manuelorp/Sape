...
<html>
    ...
    <body>
		...
		<div class="content">
			...
			<form:form method="post" modelAttribute="request" action="${pageContext.request.contextPath}/${action}">
				<table class="table">
					<tr>
						<td class="register">Request ID</td>
					...
					<tr>
						<td class="register"><input type="submit" value="Update request" class="button2" onclick="return confirm('Do you want to submit your data?')"/></td>
